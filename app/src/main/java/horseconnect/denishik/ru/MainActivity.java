...
public class MainActivity extends AppCompatActivity {
	...
	private  com.google.android.material.bottomsheet.BottomSheetDialog dialogLoading;
...
Task<GoogleSignInAccount> _task = GoogleSignIn.getSignedInAccountFromIntent(_data);
	...
	public void _onLoadingSheet () {
		dialogLoading = new com.google.android.material.bottomsheet.BottomSheetDialog(MainActivity.this); View lay = getLayoutInflater().inflate(R.layout.loading_view, null); dialogLoading.setContentView(lay);
		...
		dialogLoading.getWindow().findViewById(R.id.design_bottom_sheet).setBackgroundResource(android.R.color.transparent);
		dialogLoading.show();
		...
		inet.startRequestNetwork(RequestNetworkController.GET, "https://request.denishik.ru", "A", _inet_request_listener);
	}
	...
	public void _editbanner() {
		//set banner on view
		linear6.setTranslationX(getDisplayWidthPixels() * -1);
		LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams((int)(getDisplayWidthPixels()),
				LinearLayout.LayoutParams.MATCH_PARENT);
		linear6.setLayoutParams(lp);
	}
