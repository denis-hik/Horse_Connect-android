...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int _requestCode, int _resultCode, Intent _data) {
        ...
        if (_requestCode == REQ_CD_LOGIN) {
            if (_resultCode == Activity.RESULT_OK) {

                Task<GoogleSignInAccount> _task = com.google.android.gms.auth.api.signin.GoogleSignIn.getSignedInAccountFromIntent(_data);
    ...
    public void _onLoadingSheet() {
        ...
        View lay = getLayoutInflater().inflate(R.layout.loading_view, null);
